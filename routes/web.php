...
// Buku Route
Route::get('/buku', [BukuuController::class, 'index'])->name('halaman.buku');
...
Route::post('/addKategoriBuku', [KategoriBukuController::class, 'store'])->name('kategoribuku.store');
Route::post('/getKategoriBuku', [KategoriBukuController::class, 'getKategoriBuku'])->name('kategoribuku.get');
Route::post('/getKategoriById', [KategoriBukuController::class, 'edit'])->name('kategoribuku.edit');
Route::post('/updateKategoriBuku', [KategoriBukuController::class, 'update'])->name('kategoribuku.update');
Route::post('/deleteKategoriBuku', [KategoriBukuController::class, 'destroy'])->name('kategoribuku.destroy');
